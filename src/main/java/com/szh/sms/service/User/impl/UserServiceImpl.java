package com.szh.sms.service.User.impl;

import com.auth0.jwt.JWT;
import com.auth0.jwt.algorithms.Algorithm;
import com.szh.sms.dao.User.AdminMapper;
import com.szh.sms.dao.User.StudentMapper;
import com.szh.sms.dao.User.TeacherMapper;
import com.szh.sms.dao.User.UserMapper;
...
//    teacherObj.put("children", list);
  ...
  public User getUserById(String id) {
    ...
    User user = studentMapper.getUserById(id);
    if (user == null) {
      user = teacherMapper.getUserById(id);
    }
    if (user == null) {
