  ...
  <div>
    ...
    <el-card class="content" style="width: 36.8%;margin: 12px 12px 12px 0">
      ...
      <div style="margin-top: -15px" v-if="showPie">
        <ve-pie :data="pieData" :settings="pieSetting" :extend="pieExtend"></ve-pie>
      </div>
    ...
    <!--折线图-->
    <el-card class="content chartContent" style="width: 98%;margin: 12px 0 12px 12px">
      ...
      <div style="margin-top: -15px" v-if="showChart">
        <ve-line v-if="changeChart" :data="lineData" :extend="lineExtend" :width="lineWidth" ref="chart" :height="lineHeight"></ve-line>
        <ve-histogram :data="histogramData" :extend="histogramExtend" :height="lineHeight" ref="chart" v-else></ve-histogram>
      </div>
      <div style="text-align: center;line-height: 360px" v-else>
        <span style="color: gray">暂无数据</span>
      </div>
    </el-card>
